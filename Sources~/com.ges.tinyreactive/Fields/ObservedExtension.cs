...
namespace TinyReactive.Fields {
    public static class ObservedExtension {
        ...
        public static void SubtractValueLimit(this Observed<int> obj, int value, int limit = 0) {
            obj.Set(MathfUtility.Max(obj.value - value, limit));
        }
        ...
        public static void TrySetMin(this Observed<float> obj, params float[] values) => obj.TrySet(MathfUtility.Min(values));
        
        public static void TrySetMin(this Observed<int> obj, params int[] values) => obj.TrySet(MathfUtility.Min(values));
        
        public static void TrySetClamp(this Observed<int> obj, int value, int min, int max) => obj.TrySet(MathfUtility.Clamp(value, min, max));
        ...
        public static void TrySetMax(this Observed<float> obj, params float[] values) => obj.TrySet(MathfUtility.Max(values));
        
        public static void TrySetMax(this Observed<int> obj, params int[] values) => obj.TrySet(MathfUtility.Max(values));
