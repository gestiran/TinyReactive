...
namespace TinyReactive.Fields {
    ...
    public static class ObservedExtension {
        ...
        public static void AddValueMax(this Observed<int> obj, int value, int maxValue) => obj.Set(MathfCore.Min(obj.value + value, maxValue));
        ...
        /// <param name="value"> Amount to add. </param>
        /// <param name="maxValue"> Maximum value. </param>
        public static void AddValueMax(this Observed<float> obj, float value, float maxValue) => obj.Set(MathfCore.Min(obj.value + value, maxValue));
        ...
        public static void SubtractValueLimit(this Observed<int> obj, int value, int minValue) {
            obj.Set(MathfCore.Max(obj.value - value, minValue));
        }
        ...
        /// <returns> Operation status. </returns>
        public static bool TrySetMin(this Observed<float> obj, params float[] values) => obj.TrySet(MathfCore.Min(values));
        
        /// <summary> Set the minimum value from the passed array. </summary>
        /// <param name="obj"> Current. </param>
        /// <param name="values"> Target values. </param>
        /// <returns> Operation status. </returns>
        public static bool TrySetMin(this Observed<int> obj, params int[] values) => obj.TrySet(MathfCore.Min(values));
        ...
        /// <returns> Operation status. </returns>
        public static bool TrySetClamp(this Observed<int> obj, int value, int min, int max) => obj.TrySet(MathfCore.Clamp(value, min, max));
        ...
        /// <param name="values"> Target values. </param>
        /// <returns> Operation status. </returns>
        public static bool TrySetMax(this Observed<float> obj, params float[] values) => obj.TrySet(MathfCore.Max(values));
        
        /// <summary> Set the maximum value from the passed array. </summary>
        /// <param name="obj"> Current. </param>
        /// <param name="values"> Target values. </param>
        /// <returns> Operation status. </returns>
        public static bool TrySetMax(this Observed<int> obj, params int[] values) => obj.TrySet(MathfCore.Max(values));
